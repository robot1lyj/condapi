...
class PI0Pytorch(nn.Module):
    def __init__(self, config, *, compile_model=True):
        ...
        msg = (
            "transformers_replace is not installed correctly. Please install "
            "`transformers==4.53.2` and then run "
            "`python scripts/conda/patch_transformers.py --openpi-dir <openpi_repo>` "
    ...
    def embed_suffix(self, state, noisy_actions, timestep, *, time_embedding=None):
    ...
    def denoise_step(
        ...
        *,
        ...
        suffix_embs, suffix_pad_masks, suffix_att_masks, adarms_cond = self.embed_suffix(
            state, x_t, timestep, time_embedding=time_embedding
        )
        ...
        self.paligemma_with_expert.gemma_expert.model.config._attn_implementation = self.attention_implementation  # noqa: SLF001
