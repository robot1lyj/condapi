...
<body><main>
<header><h1>OpenArm K-Policy 训练报告</h1><p>路线 K: Stage Advantage 二值 AWBC, 从 pi0.5 base 训练、双域离线选模并部署。</p><div class="chips"><span class="chip" id="generated"></span><span class="chip">absolute_advantage · stage top-30%</span><span class="chip">multi-node · 80k</span></div></header>
...
<div class="card"><div class="label">gpu25 服务</div><div class="value" id="endpoint"></div><div class="detail" id="deploy-prompt"></div><div class="detail" id="deploy-smoke"></div></div>
</div></section>
...
const S=D.deployment.inference_smoke||{{}};$('deploy-smoke').textContent=S.passed?'推理 smoke PASS · '+f(S.elapsed_ms,0)+' ms · '+((S.actions||{{}}).shape||[]).join('x'):'推理 smoke 缺失';
