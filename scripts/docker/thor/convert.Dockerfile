...
COPY src /app/src
COPY adapters/openpi/convert_jax_model_to_pytorch.py /app/adapters/openpi/convert_jax_model_to_pytorch.py
...
CMD ["python3", "/app/adapters/openpi/convert_jax_model_to_pytorch.py", "--help"]
