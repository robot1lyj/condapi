...
- YAM 已实现路线为 Pi0.5 全量微调 / `pi05_yam`。2026-09-16用户因抓取效果差暂停训练，完整基线100000；先核对“乐高分拣3”异步夹爪预测/选择/提交差异，再做小集及Evo对照，尚未切默认模型。状态、预算和证据归 [训练](../03_training_and_evaluation.md#2026-09-16--训练重设计先复现乐高分拣再比较模型)，恢复前复核现场；不自动回退LoRA。
