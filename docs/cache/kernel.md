...
- 2026-09-07 22:44，非量化 BF16/FP32 ONNX r3 已成功导出（9 组准备前后输出完全一致、退出恢复 120W）；TensorRT 引擎构建和真实精度/延迟仍待验收，不计入前述 14 组成绩。详见 [加速执行记录](../reference/thor/10_acceleration_execution.md)。
