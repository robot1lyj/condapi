...
- r7 profile将主要GPU时间定位到矩阵乘法和自定义掩码联合注意力。新增同形状BF16注意力后端探针，仅作支持性/单算子测速；2026-09-23 Thor管理网地址不可达，探针尚未在Thor运行。证据与网络边界见[优化报告](reports/thor/openwam-20260922/bf16-optimization.md)。Pi按用户指示保持停止，3588未操作。
