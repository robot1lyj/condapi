...
**2026-09-23 最新状态**：用户因训练资源不足要求暂停 OpenWAM 设计、回归 Pi0.5。21 个已停止的 OpenWAM 试验/下载容器及其可写层已删除；官方原始检查点、`openwam:thor-20260922-r1/r2` 环境镜像、源码与实验日志保留，没有清理通用 Docker build cache。Pi 已切换 20h136000，见[当前 Pi 报告](../../reports/thor/rtc-20h-136000-20260923/README.md)。下文“保持 Pi 停止”等操作描述是当时历史状态，不应继续执行。
